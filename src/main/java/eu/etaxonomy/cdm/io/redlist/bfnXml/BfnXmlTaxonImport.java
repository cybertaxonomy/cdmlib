 ...
 */
@Component
public class BfnXmlTaxonImport  extends BfnXmlImportBase implements ICdmIO<BfnXmlImportState> {
	
	private static final Logger logger = Logger.getLogger(BfnXmlTaxonImport.class);

	private static int modCount = 30000;
	
	public BfnXmlTaxonImport(){
		super();
	}
