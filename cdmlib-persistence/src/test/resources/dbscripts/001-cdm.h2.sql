...
ALTER TABLE PUBLIC.POLYTOMOUSKEY_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX341 PRIMARY KEY(POLYTOMOUSKEY_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_SEQUENCE_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXBAD PRIMARY KEY(REV, SPECIMENOROBSERVATIONBASE_ID, SEQUENCES_ID);
...
ALTER TABLE PUBLIC.TAXONBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX185 PRIMARY KEY(TAXONBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.TERMVOCABULARY_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX371 PRIMARY KEY(TERMVOCABULARY_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.RIGHTS_ANNOTATION_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX301 PRIMARY KEY(REV, RIGHTS_ID, ANNOTATIONS_ID);
ALTER TABLE PUBLIC.REFERENCE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXF43 PRIMARY KEY(REV, REFERENCE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.FEATURETREE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX9E6 PRIMARY KEY(REV, FEATURETREE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_SEQUENCE ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXBE63 PRIMARY KEY(SPECIMENOROBSERVATIONBASE_ID, SEQUENCES_ID);
...
ALTER TABLE PUBLIC.RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXCB PRIMARY KEY(ID, REV);
...
ALTER TABLE PUBLIC.COLLECTION_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXDA PRIMARY KEY(REV, COLLECTION_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_MEDIA_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXD0 PRIMARY KEY(REV, SPECIMENOROBSERVATIONBASE_ID, MEDIA_ID);
...
ALTER TABLE PUBLIC.TAXONNAMEBASE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXD56 PRIMARY KEY(REV, TAXONNAMEBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.RIGHTS_MARKER ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX14B PRIMARY KEY(RIGHTS_ID, MARKERS_ID);
ALTER TABLE PUBLIC.FEATURETREE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXF9 PRIMARY KEY(FEATURETREE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.CLASSIFICATION_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXF5 PRIMARY KEY(CLASSIFICATION_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.AGENTBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXF1 PRIMARY KEY(AGENTBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.COLLECTION_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXDD PRIMARY KEY(COLLECTION_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX901 PRIMARY KEY(ID);
...
ALTER TABLE PUBLIC.TAXONNAMEBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXA1D PRIMARY KEY(TAXONNAMEBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.MEDIA_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX2E PRIMARY KEY(MEDIA_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.MEDIA_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX13 PRIMARY KEY(REV, MEDIA_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.RIGHTS_MARKER_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXFD2 PRIMARY KEY(REV, RIGHTS_ID, MARKERS_ID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXB36 PRIMARY KEY(SPECIMENOROBSERVATIONBASE_ID, RIGHTS_ID);
...
--ALTER TABLE PUBLIC.SEQUENCE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXA9D PRIMARY KEY(REV, SEQUENCE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.RIGHTS_ANNOTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX5DE PRIMARY KEY(RIGHTS_ID, ANNOTATIONS_ID);
...
ALTER TABLE PUBLIC.POLYTOMOUSKEY_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXA9 PRIMARY KEY(REV, POLYTOMOUSKEY_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX6A PRIMARY KEY(REV, SPECIMENOROBSERVATIONBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIONBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX65 PRIMARY KEY(DESCRIPTIONBASE_ID, RIGHTS_ID);
ALTER TABLE PUBLIC.DESCRIPTIONBASE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX6F PRIMARY KEY(REV, DESCRIPTIONBASE_ID, RIGHTS_ID);
ALTER TABLE PUBLIC.DEFINEDTERMBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX69 PRIMARY KEY(DEFINEDTERMBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.REFERENCE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX8A PRIMARY KEY(REFERENCE_ID, RIGHTS_ID);
ALTER TABLE PUBLIC.MEDIA_ANNOTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX87CF PRIMARY KEY(MEDIA_ID, ANNOTATIONS_ID);
ALTER TABLE PUBLIC.CLASSIFICATION_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX8F PRIMARY KEY(REV, CLASSIFICATION_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.TAXONBASE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX61 PRIMARY KEY(REV, TAXONBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_WATERBODYORCOUNTRY_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX96 PRIMARY KEY(REV, DEFINEDTERMBASE_ID, WATERBODIESORCOUNTRIES_ID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_MEDIA ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX39 PRIMARY KEY(SPECIMENOROBSERVATIONBASE_ID, MEDIA_ID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX36 PRIMARY KEY(REV, DEFINEDTERMBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_WATERBODYORCOUNTRY ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXDBE PRIMARY KEY(DEFINEDTERMBASE_ID, WATERBODIESORCOUNTRIES_ID);
...
ALTER TABLE PUBLIC.AGENTBASE_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX63456AE PRIMARY KEY(REV, AGENTBASE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.TERMVOCABULARY_RIGHTS_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXCFF PRIMARY KEY(REV, TERMVOCABULARY_ID, RIGHTS_ID);
...
--ALTER TABLE PUBLIC.SEQUENCE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX97 PRIMARY KEY(SEQUENCE_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.AGENTBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXF1E UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.REFERENCE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX8AD UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.TAXONNAMEBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXA1D5 UNIQUE(RIGHTS_ID);
...
--ALTER TABLE PUBLIC.SEQUENCE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXXXX977 UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXXXX9013 UNIQUE(UUID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXB36B UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIONBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX65C UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.TAXONBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX185F UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.POLYTOMOUSKEY_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX341F UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.CLASSIFICATION_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXF52 UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.COLLECTION_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXDD7 UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.FEATURETREE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXF96 UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_SEQUENCE ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXBE634 UNIQUE(SEQUENCES_ID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX69B UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.TERMVOCABULARY_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX371A UNIQUE(RIGHTS_ID);
...
ALTER TABLE PUBLIC.RIGHTS_ANNOTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX5DEB UNIQUE(ANNOTATIONS_ID);
...
ALTER TABLE PUBLIC.RIGHTS_MARKER ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX14BB UNIQUE(MARKERS_ID);
...
ALTER TABLE PUBLIC.MEDIA_RIGHTS ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX2EC UNIQUE(RIGHTS_ID);
