...
create table Annotation (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), linkbackurlstr varchar(255), updatedby_id integer, commentator_id integer, createdby_id integer, language_id integer, primary key (id));
...
create table Collection (id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, code varchar(255), codestandard varchar(255), name varchar(255), townorlocation varchar(255), institute_id integer, updatedby_id integer, supercollection_id integer, createdby_id integer, primary key (id));
...
create table DefinedTermBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, uri varchar(255), orderindex integer, iso639_1 varchar(2), iso639_2 varchar(3), defaultcolor varchar(255), supportscommontaxonname boolean, supportsdistribution boolean, supportsindividualassociation boolean, supportsquantitativedata boolean, supportstaxoninteraction boolean, supportstextdata boolean, pointapproximation_errorradius integer, pointapproximation_latitude double, pointapproximation_longitude double, validperiod_end varchar(255), validperiod_start varchar(255), iso3166_a2 varchar(2), symmetric boolean, transitive boolean, pointapproximation_referencesystem_id integer, createdby_id integer, persistentvocabulary_id integer, partof_id integer, updatedby_id integer, type_id integer, level_id integer, kindof_id integer, shape_id integer, primary key (id));
...
create table DerivationEvent (id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varchar(255), timeperiod_end varchar(255), timeperiod_start varchar(255), updatedby_id integer, type_id integer, actor_id integer, createdby_id integer, primary key (id));
...
create table DescriptionBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, updatedby_id integer, taxonName_fk integer, taxon_fk integer, createdby_id integer, primary key (id));
...
create table DescriptionElementBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), modifyingtext varbinary(255), orderrelevant boolean, name varchar(255), description varbinary(255), updatedby_id integer, format_id integer, citation_id integer, associatedspecimenorobservation_id integer, status_id integer, indescription_id integer, feature_id integer, taxon2_id integer, area_id integer, createdby_id integer, language_id integer, unit_id integer, primary key (id));
...
create table DeterminationEvent (id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varchar(255), timeperiod_end varchar(255), timeperiod_start varchar(255), preferredflag boolean not null, identifiedunit_id integer, taxon_id integer, modifier_id integer, createdby_id integer, updatedby_id integer, actor_id integer, primary key (id));
...
create table FeatureNode (id integer not null, created timestamp, uuid varchar(255), updated timestamp, parent_fk integer, createdby_id integer, feature_id integer, updatedby_id integer, primary key (id));
...
create table GatheringEvent (id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varchar(255), timeperiod_end varchar(255), timeperiod_start varchar(255), absoluteelevation integer, absoluteelevationerror integer, collectingmethod varchar(255), distancetoground integer, distancetowatersurface integer, exactlocation_errorradius integer, exactlocation_latitude double, exactlocation_longitude double, locality_id integer, exactlocation_referencesystem_id integer, actor_id integer, updatedby_id integer, createdby_id integer, primary key (id));
...
create table InstitutionalMembership (id integer not null, created timestamp, uuid varchar(255), updated timestamp, department varchar(255), period_end varchar(255), period_start varchar(255), role varchar(255), institute_id integer, updatedby_id integer, person_id integer, createdby_id integer, primary key (id));
create table LanguageString (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), updatedby_id integer, createdby_id integer, language_id integer, primary key (id));
...
create table Marker (id integer not null, created timestamp, uuid varchar(255), updated timestamp, flag boolean not null, updatedby_id integer, markertype_id integer, createdby_id integer, primary key (id));
create table Media (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varbinary(255), mediacreated date, title varbinary(255), citationmicroreference varchar(255), updatedby_id integer, createdby_id integer, artist_id integer, citation_id integer, primary key (id));
...
create table NomenclaturalStatus (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), ruleconsidered varchar(255), citation_id integer, updatedby_id integer, type_id integer, createdby_id integer, primary key (id));
...
create table Representation (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), abbreviatedlabel varchar(255), label varchar(255), updatedby_id integer, language_id integer, createdby_id integer, primary key (id));
create table Rights (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), abbreviatedtext varchar(255), uri varchar(255), agent_id integer, language_id integer, updatedby_id integer, createdby_id integer, primary key (id));
create table Sequence (id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, barcode boolean not null, citationmicroreference varchar(255), datesequenced date, length integer, sequence varchar(255), locus_id integer, publishedin_id integer, createdby_id integer, updatedby_id integer, primary key (id));
...
create table SpecimenOrObservationBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, definition varbinary(255), individualcount integer, accessionnumber varchar(255), catalognumber varchar(255), collectorsnumber varchar(255), fieldnotes varchar(255), fieldnumber varchar(255), updatedby_id integer, preservation_id integer, derivationevent_id integer, createdby_id integer, storedunder_id integer, lifestage_id integer, gatheringevent_id integer, sex_id integer, collection_id integer, primary key (id));
...
create table StateData (id integer not null, created timestamp, uuid varchar(255), updated timestamp, modifyingtext varbinary(255), updatedby_id integer, state_id integer, createdby_id integer, primary key (id));
...
create table StatisticalMeasurementValue (id integer not null, created timestamp, uuid varchar(255), updated timestamp, value double not null, updatedby_id integer, type_id integer, createdby_id integer, primary key (id));
...
create table SynonymRelationship (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), doubtful boolean not null, partial boolean not null, proparte boolean not null, relatedto_id integer, relatedfrom_id integer, citation_id integer, type_id integer, createdby_id integer, updatedby_id integer, primary key (id));
...
create table TaxonBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, doubtful boolean not null, taxonomicchildrencount integer, sec_id integer, updatedby_id integer, taxonName_fk integer, createdby_id integer, taxonomicparentcache_id integer, primary key (id));
...
create table TaxonRelationship (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), doubtful boolean not null, citation_id integer, relatedfrom_id integer, updatedby_id integer, relatedto_id integer, type_id integer, createdby_id integer, primary key (id));
