...
create table Annotation (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), linkbackurlstr varchar(255), updatedby_id integer, language_id integer, createdby_id integer, commentator_id integer, primary key (id));
...
create table Collection (id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, code varchar(255), codestandard varchar(255), name varchar(255), townorlocation varchar(255), createdby_id integer, institute_id integer, updatedby_id integer, supercollection_id integer, primary key (id));
...
create table DerivationEvent (id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varchar(255), timeperiod_end varchar(255), timeperiod_start varchar(255), actor_id integer, type_id integer, updatedby_id integer, createdby_id integer, primary key (id));
...
create table DescriptionBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, taxonName_fk integer, taxon_fk integer, updatedby_id integer, createdby_id integer, primary key (id));
...
create table DescriptionElementBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), modifyingtext varbinary(255), orderrelevant boolean, name varchar(255), description varbinary(255), format_id integer, citation_id integer, area_id integer, unit_id integer, createdby_id integer, updatedby_id integer, language_id integer, feature_id integer, status_id integer, associatedspecimenorobservation_id integer, taxon2_id integer, primary key (id));
...
create table DeterminationEvent (id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varchar(255), timeperiod_end varchar(255), timeperiod_start varchar(255), preferredflag boolean not null, identifiedunit_id integer, updatedby_id integer, createdby_id integer, modifier_id integer, actor_id integer, taxon_id integer, primary key (id));
...
create table Extension (id integer not null, created timestamp, uuid varchar(255), updated timestamp, value varchar(255), createdby_id integer, type_id integer, updatedby_id integer, primary key (id));
create table FeatureNode (id integer not null, created timestamp, uuid varchar(255), updated timestamp, parent_fk integer, updatedby_id integer, createdby_id integer, feature_id integer, primary key (id));
create table FeatureTree (id integer not null, created timestamp, uuid varchar(255), updated timestamp, uri varchar(255), descriptionseparated boolean not null, root_id integer, updatedby_id integer, createdby_id integer, primary key (id));
...
create table GatheringEvent (id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varchar(255), timeperiod_end varchar(255), timeperiod_start varchar(255), absoluteelevation integer, absoluteelevationerror integer, collectingmethod varchar(255), distancetoground integer, distancetowatersurface integer, exactlocation_errorradius integer, exactlocation_latitude double, exactlocation_longitude double, updatedby_id integer, locality_id integer, createdby_id integer, exactlocation_referencesystem_id integer, actor_id integer, primary key (id));
...
create table HybridRelationship (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), ruleconsidered varchar(255), createdby_id integer, type_id integer, relatedfrom_id integer, relatedto_id integer, updatedby_id integer, citation_id integer, primary key (id));
...
create table LanguageString (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), language_id integer, createdby_id integer, updatedby_id integer, primary key (id));
...
create table Marker (id integer not null, created timestamp, uuid varchar(255), updated timestamp, flag boolean not null, markertype_id integer, updatedby_id integer, createdby_id integer, primary key (id));
create table Media (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, description varbinary(255), mediacreated date, title varbinary(255), citationmicroreference varchar(255), artist_id integer, citation_id integer, createdby_id integer, updatedby_id integer, primary key (id));
...
create table NameRelationship (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), ruleconsidered varchar(255), citation_id integer, createdby_id integer, updatedby_id integer, relatedfrom_id integer, type_id integer, relatedto_id integer, primary key (id));
...
create table NomenclaturalStatus (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), ruleconsidered varchar(255), citation_id integer, type_id integer, updatedby_id integer, createdby_id integer, primary key (id));
...
create table OriginalSource (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), idinsource varchar(255), idnamespace varchar(255), citation_id integer, createdby_id integer, updatedby_id integer, primary key (id));
...
create table Representation (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), abbreviatedlabel varchar(255), label varchar(255), updatedby_id integer, createdby_id integer, language_id integer, primary key (id));
create table Rights (id integer not null, created timestamp, uuid varchar(255), updated timestamp, text varchar(4096), abbreviatedtext varchar(255), uri varchar(255), language_id integer, createdby_id integer, agent_id integer, updatedby_id integer, primary key (id));
create table Sequence (id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, barcode boolean not null, citationmicroreference varchar(255), datesequenced date, length integer, sequence varchar(255), createdby_id integer, publishedin_id integer, updatedby_id integer, locus_id integer, primary key (id));
...
create table SpecimenOrObservationBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, definition varbinary(255), individualcount integer, accessionnumber varchar(255), catalognumber varchar(255), collectorsnumber varchar(255), fieldnotes varchar(255), fieldnumber varchar(255), preservation_id integer, derivationevent_id integer, lifestage_id integer, createdby_id integer, collection_id integer, gatheringevent_id integer, sex_id integer, updatedby_id integer, storedunder_id integer, primary key (id));
...
create table StateData (id integer not null, created timestamp, uuid varchar(255), updated timestamp, modifyingtext varbinary(255), state_id integer, createdby_id integer, updatedby_id integer, primary key (id));
...
create table StatisticalMeasurementValue (id integer not null, created timestamp, uuid varchar(255), updated timestamp, value float not null, type_id integer, updatedby_id integer, createdby_id integer, primary key (id));
...
create table SynonymRelationship (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), partial boolean not null, proparte boolean not null, citation_id integer, relatedfrom_id integer, createdby_id integer, type_id integer, relatedto_id integer, updatedby_id integer, primary key (id));
...
create table TaxonBase (DTYPE varchar(31) not null, id integer not null, created timestamp, uuid varchar(255), updated timestamp, lsid varchar(255), titleCache varchar(255), protectedtitlecache boolean not null, doubtful boolean not null, taxonomicchildrencount integer, updatedby_id integer, taxonName_fk integer, sec_id integer, createdby_id integer, taxonomicparentcache_id integer, primary key (id));
...
create table TaxonRelationship (id integer not null, created timestamp, uuid varchar(255), updated timestamp, citationmicroreference varchar(255), originalnamestring varchar(255), type_id integer, createdby_id integer, relatedfrom_id integer, updatedby_id integer, relatedto_id integer, citation_id integer, primary key (id));
