 ...
 * errors. In general you can view errors from the perspective of the constraints being
 * violated, irrespective of the entities that violated them. Or you can focus on the
