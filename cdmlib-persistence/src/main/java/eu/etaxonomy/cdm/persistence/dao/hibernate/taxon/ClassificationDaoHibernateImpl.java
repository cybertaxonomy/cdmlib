    ...
    private <R extends Object> Query<R> prepareListChildrenOf(Taxon taxon, Classification classification, TaxonNode subtree,
    	 ...
    	 String selectWhat = queryType == QueryType.COUNT ? "COUNT(cn)"
    	         ...
    	         : (" new " +SortableTaxonNodeQueryResult.class.getName()+"("
    	                 ...
    	                 + ", sec.uuid"
    	                 + ", ct.name.nameType"
                         + ", ct.name.genusOrUninomial"
                         + ", ct.name.infraGenericEpithet"
                         + ", ct.name.specificEpithet"
                         + ", ct.name.infraSpecificEpithet"
                         + ", ct.name.appendedPhrase"
                         + ", ct.name.protectedTitleCache"
                         + ", ct.name.protectedNameCache"
                         + ", ct.name.nameCache"
                         + ", ct.name.authorshipCache"
                         + ", ct.name.publicationYear"
                         + ", ct.name.monomHybrid"
                         + ", ct.name.binomHybrid"
...
//    	                 + "cn.taxon.name.rank.titleCache "  //TODO maybe ...rank.representations (?)
         ...
         String hql = "SELECT " + selectWhat
                 ...
                 + "   JOIN cn.taxon AS ct "
                 + "   JOIN ct.name AS ctn "
                 + "   LEFT JOIN ctn.rank r "
                 + "   LEFT JOIN ct.secSource ss "
                 + "   LEFT JOIN ss.citation sec "
                 + " WHERE t = :taxon "
