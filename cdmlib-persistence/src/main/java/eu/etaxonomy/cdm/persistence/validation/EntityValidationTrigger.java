 ...
 * Validation may not not have been triggered by any CRUD event at all, e.g. during some
 * batch-like validation process. Level-2 validation can never be triggered by a DELETE event,
 * because Level-2 validation only validates the entity itself. However, a DELETE event
