...
public class NotNullUpdater
    ...
    public static NotNullUpdater NewStringInstance(List<ISchemaUpdaterStep> stepList, String stepName,
            String tableName, String columnName, boolean includeAudTable){
        return new NotNullUpdater(stepList, stepName, tableName, columnName, includeAudTable, Datatype.VARCHAR, 255);
    }

    public static NotNullUpdater NewStringInstance(List<ISchemaUpdaterStep> stepList, String stepName, String tableName, String columnName,
    ...
    protected void invokeOnTable(String tableName, ICdmDataSource datasource,
        ...
        try {
            ...
            if (type.isSqlServer()){
                ...
                updateQuery1 = "ALTER TABLE @tableName ALTER COLUMN @columnName @definition NOT NULL";
            }else if ( type.isMySqlMariaDB()){
                //FIXME MySQL column name changer
                //logger.warn("Changing column name not yet supported for MySQL");
                updateQuery1 = "ALTER TABLE @tableName MODIFY @columnName @definition NOT NULL";
            }else if (type.isH2()){
                updateQuery1 = "ALTER TABLE @tableName ALTER COLUMN @columnName SET NOT NULL";
