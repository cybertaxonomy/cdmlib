...
/**
 * NOTE:
 * This class is not in use anymore. It will be removed in one of the next versions.
 * The former class was called <code>TdwgArea</code> 
 * 
...
//@Audited
@Deprecated
public class TdwgArea_Old extends NamedArea implements Cloneable{
    private static final long serialVersionUID = 4662215686356109015L;
    private static final Logger logger = Logger.getLogger(TdwgArea_Old.class);
...
//
//    protected static Map<UUID, TdwgArea_Old> termMap = null;
...
//    protected static TdwgArea_Old getTermByUuid(UUID uuid){
//        if (termMap == null){
//            DefaultTermInitializer vocabularyStore = new DefaultTermInitializer();
//            vocabularyStore.initialize();
//        }
//        return (TdwgArea_Old)termMap.get(uuid);
//    }
...
//            return null;
//        }
//        return TdwgArea_Old.getTermByUuid(uuid);
//    }
//
//    /**
//     * FIXME This class should really be refactored into an interface and service implementation,
...
//    @Override
//    protected void setDefaultTerms(TermVocabulary<NamedArea> termVocabulary) {
//        termMap = new HashMap<UUID, TdwgArea_Old>();
//        for (NamedArea term : termVocabulary.getTerms()){
//            termMap.put(term.getUuid(), (TdwgArea_Old)term);  //TODO casting
//            addTdwgArea(term);
//        }
//    }
