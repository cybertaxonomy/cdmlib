...
CREATE CACHED TABLE PUBLIC.AGENTBASE_EXTERNALLINK(
    AGENTBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.AGENTBASE_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.AGENTBASE_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    AGENTBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.AGENTBASE_EXTERNALLINK_AUD;
...
CREATE CACHED TABLE PUBLIC.CLASSIFICATION_EXTERNALLINK(
    CLASSIFICATION_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.CLASSIFICATION_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.CLASSIFICATION_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    CLASSIFICATION_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.CLASSIFICATION_EXTERNALLINK_AUD;
...
CREATE CACHED TABLE PUBLIC.COLLECTION_EXTERNALLINK(
    COLLECTION_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.COLLECTION_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.COLLECTION_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    COLLECTION_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.COLLECTION_EXTERNALLINK_AUD;
...
CREATE CACHED TABLE PUBLIC.DEFINEDTERMBASE(
	...
	SUPPORTEDDATATYPES VARCHAR(100),
...
CREATE CACHED TABLE PUBLIC.DEFINEDTERMBASE_EXTERNALLINK(
    DEFINEDTERMBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DEFINEDTERMBASE_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.DEFINEDTERMBASE_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    DEFINEDTERMBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DEFINEDTERMBASE_EXTERNALLINK_AUD;                                                                                                    
...
CREATE CACHED TABLE PUBLIC.DESCRIPTIONBASE_EXTERNALLINK(
    DESCRIPTIONBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DESCRIPTIONBASE_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.DESCRIPTIONBASE_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    DESCRIPTIONBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DESCRIPTIONBASE_EXTERNALLINK_AUD;    
...
CREATE CACHED TABLE PUBLIC.DESCRIPTIVEDATASET_EXTENSION_AUD(
    REV INTEGER NOT NULL,
    DESCRIPTIVEDATASET_ID INTEGER NOT NULL,
    EXTENSIONS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
...
CREATE CACHED TABLE PUBLIC.DESCRIPTIVEDATASET_EXTERNALLINK(
    DESCRIPTIVEDATASET_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DESCRIPTIVEDATASET_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.DESCRIPTIVEDATASET_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    DESCRIPTIVEDATASET_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DESCRIPTIVEDATASET_EXTERNALLINK_AUD;    
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.CDMLINK;
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.CDMLINK_AUD;
...
CREATE CACHED TABLE PUBLIC.MEDIAMETADATA(
	...
	MEDIAREPRESENTATION_ID INTEGER NOT NULL
);
...
CREATE CACHED TABLE PUBLIC.MEDIA_EXTERNALLINK(
    MEDIA_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.MEDIA_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.MEDIA_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    MEDIA_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.MEDIA_EXTERNALLINK_AUD;   
...
CREATE CACHED TABLE PUBLIC.POLYTOMOUSKEY_EXTERNALLINK(
    POLYTOMOUSKEY_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.POLYTOMOUSKEY_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.POLYTOMOUSKEY_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    POLYTOMOUSKEY_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.POLYTOMOUSKEY_EXTERNALLINK_AUD;  
...
CREATE CACHED TABLE PUBLIC.REFERENCE_EXTERNALLINK(
    REFERENCE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.REFERENCE_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.REFERENCE_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    REFERENCE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.REFERENCE_EXTERNALLINK_AUD;  
...
CREATE CACHED TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_EXTERNALLINK(
    SPECIMENOROBSERVATIONBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SPECIMENOROBSERVATIONBASE_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.SPECIMENOROBSERVATIONBASE_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    SPECIMENOROBSERVATIONBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SPECIMENOROBSERVATIONBASE_EXTERNALLINK_AUD;  
...
CREATE CACHED TABLE PUBLIC.TAXONBASE_EXTERNALLINK(
    TAXONBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TAXONBASE_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.TAXONBASE_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    TAXONBASE_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TAXONBASE_EXTERNALLINK_AUD; 
...
CREATE CACHED TABLE PUBLIC.TAXONNAME_EXTERNALLINK(
    TAXONNAME_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TAXONNAME_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.TAXONNAME_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    TAXONNAME_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TAXONNAME_EXTERNALLINK_AUD; 
...
CREATE CACHED TABLE PUBLIC.TAXONNODE_STATUSNOTE(
    TAXONNODE_ID INTEGER NOT NULL,
    STATUSNOTE_ID INTEGER NOT NULL,
	STATUSNOTE_KEY INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TAXONNODE_STATUSNOTE;
CREATE CACHED TABLE PUBLIC.TAXONNODE_STATUSNOTE_AUD(
    REV INTEGER NOT NULL,
    TAXONNODE_ID INTEGER NOT NULL,
    STATUSNOTE_ID INTEGER NOT NULL,
	STATUSNOTE_KEY INTEGER NOT NULL,
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TAXONNODE_STATUSNOTE_AUD;
...
CREATE CACHED TABLE PUBLIC.TERMCOLLECTION_EXTERNALLINK(
    TERMCOLLECTION_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TERMCOLLECTION_EXTERNALLINK;
CREATE CACHED TABLE PUBLIC.TERMCOLLECTION_EXTERNALLINK_AUD(
    REV INTEGER NOT NULL,
    TERMCOLLECTION_ID INTEGER NOT NULL,
    LINKS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TERMCOLLECTION_EXTERNALLINK_AUD; 
...
CREATE CACHED TABLE PUBLIC.TERMNODE_INAPPLICABLEIF(
    TERMNODE_ID INTEGER NOT NULL,
	INAPPLICABLEIF_ID INTEGER NOT NULL,
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TERMNODE_INAPPLICABLEIF;
CREATE CACHED TABLE PUBLIC.TERMNODE_INAPPLICABLEIF_AUD(
    REV INTEGER NOT NULL,
    TERMNODE_ID INTEGER NOT NULL,
	INAPPLICABLEIF_ID INTEGER NOT NULL,
	REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TERMNODE_INAPPLICABLEIF_AUD;
CREATE CACHED TABLE PUBLIC.TERMNODE_ONLYAPPLICABLEIF(
    TERMNODE_ID INTEGER NOT NULL,
	ONLYAPPLICABLEIF_ID INTEGER NOT NULL,
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TERMNODE_INAPPLICABLEIF;
CREATE CACHED TABLE PUBLIC.TERMNODE_ONLYAPPLICABLEIF_AUD(
    REV INTEGER NOT NULL,
    TERMNODE_ID INTEGER NOT NULL,
	ONLYAPPLICABLEIF_ID INTEGER NOT NULL,
	REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TERMNODE_ONLYAPPLICABLEIF_AUD;
...
CREATE CACHED TABLE PUBLIC.USERACCOUNT_AUTHORITY(
    USER_ID INTEGER NOT NULL,
    AUTHORITIES_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.USERACCOUNT_AUTHORITY;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_ANNOTATION_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXBCB PRIMARY KEY(REV, DESCRIPTIVEDATASET_ID, ANNOTATIONS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_ORIGINALSOURCEBASE ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX36E PRIMARY KEY(TERMCOLLECTION_ID, SOURCES_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_RIGHTSINFO ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX371 PRIMARY KEY(TERMCOLLECTION_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_REPRESENTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX30E PRIMARY KEY(TERMCOLLECTION_ID, REPRESENTATIONS_ID);
ALTER TABLE PUBLIC.TERMCOLLECTION_ORIGINALSOURCEBASE_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX9D7 PRIMARY KEY(REV, TERMCOLLECTION_ID, SOURCES_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_MARKER ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX2E2 PRIMARY KEY(TERMCOLLECTION_ID, MARKERS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_ANNOTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXC4D PRIMARY KEY(TERMCOLLECTION_ID, ANNOTATIONS_ID);
...
ALTER TABLE PUBLIC.DETERMINATIONEVENT_REFERENCE_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXD6 PRIMARY KEY(REV, DETERMINATIONEVENT_ID, REFERENCES_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_MARKER_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX8BD PRIMARY KEY(REV, DESCRIPTIVEDATASET_ID, MARKERS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_CREDIT_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXFFF PRIMARY KEY(REV, TERMCOLLECTION_ID, CREDITS_ID, SORTINDEX);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_ANNOTATION_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXAF1 PRIMARY KEY(REV, TERMCOLLECTION_ID, ANNOTATIONS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_EXTENSION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXC3CB PRIMARY KEY(TERMCOLLECTION_ID, EXTENSIONS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_EXTENSION_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXB49 PRIMARY KEY(REV, TERMCOLLECTION_ID, EXTENSIONS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_ANNOTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXEC9 PRIMARY KEY(DESCRIPTIVEDATASET_ID, ANNOTATIONS_ID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_INVERSEREPRESENTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXA96 PRIMARY KEY(DEFINEDTERMBASE_ID, INVERSEREPRESENTATIONS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_DESCRIPTIONBASE_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXDAF PRIMARY KEY(REV, DESCRIPTIVEDATASETS_ID, DESCRIPTIONS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_MARKER_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX64 PRIMARY KEY(REV, TERMCOLLECTION_ID, MARKERS_ID);
...
ALTER TABLE PUBLIC.DETERMINATIONEVENT_REFERENCE ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX86 PRIMARY KEY(DETERMINATIONEVENT_ID, REFERENCES_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_CREDIT ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX1DF PRIMARY KEY(TERMCOLLECTION_ID, SORTINDEX);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_REPRESENTATION_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXC9 PRIMARY KEY(REV, DESCRIPTIVEDATASET_ID, REPRESENTATIONS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_REPRESENTATION_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX86A PRIMARY KEY(REV, TERMCOLLECTION_ID, REPRESENTATIONS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_REPRESENTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX3E8 PRIMARY KEY(DESCRIPTIVEDATASET_ID, REPRESENTATIONS_ID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_INVERSEREPRESENTATION_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX51 PRIMARY KEY(REV, DEFINEDTERMBASE_ID, INVERSEREPRESENTATIONS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_MARKER ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX99 PRIMARY KEY(DESCRIPTIVEDATASET_ID, MARKERS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_RIGHTSINFO_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXCFF PRIMARY KEY(REV, TERMCOLLECTION_ID, RIGHTS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_MARKER ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX99E UNIQUE(MARKERS_ID);
...
ALTER TABLE PUBLIC.TERMRELATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX69E7 UNIQUE(UUID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_INVERSEREPRESENTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXXA961 UNIQUE(INVERSEREPRESENTATIONS_ID);
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_REPRESENTATION ADD CONSTRAINT PUBLIC.CONSTRAINT_XXX3E88 UNIQUE(REPRESENTATIONS_ID);
...
ALTER TABLE PUBLIC.TERMCOLLECTION_MARKER ADD CONSTRAINT PUBLIC.FK862BAEA7258E060 FOREIGN KEY(TERMCOLLECTION_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.TERMCOLLECTION_EXTENSION ADD CONSTRAINT PUBLIC.FKA8814EB2258E060 FOREIGN KEY(TERMCOLLECTION_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DETERMINATIONEVENT_REFERENCE ADD CONSTRAINT PUBLIC.FK8FB1ED8355A53F64 FOREIGN KEY(REFERENCES_ID) REFERENCES PUBLIC.REFERENCE(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_MARKER_AUD ADD CONSTRAINT PUBLIC.FK6AEAB69934869AAE FOREIGN KEY(REV) REFERENCES PUBLIC.AUDITEVENT(REVISIONNUMBER) NOCHECK;
...
ALTER TABLE PUBLIC.TERMCOLLECTION_ANNOTATION ADD CONSTRAINT PUBLIC.FK76D2071C258E060 FOREIGN KEY(TERMCOLLECTION_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_ANNOTATION ADD CONSTRAINT PUBLIC.FKCBBA8CBDBBD2C869 FOREIGN KEY(DESCRIPTIVEDATASET_ID) REFERENCES PUBLIC.DESCRIPTIVEDATASET(ID) NOCHECK;
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_MARKER ADD CONSTRAINT PUBLIC.FK9CB22CC8777265A1 FOREIGN KEY(MARKERS_ID) REFERENCES PUBLIC.MARKER(ID) NOCHECK;
...
ALTER TABLE PUBLIC.MULTIACCESSKEY_SCOPE ADD CONSTRAINT PUBLIC.FKCC6CE4F7B4555A9A FOREIGN KEY(MULTIACCESSKEY_ID) REFERENCES PUBLIC.DESCRIPTIVEDATASET(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_ANNOTATION_AUD ADD CONSTRAINT PUBLIC.FK1E28140E34869AAE FOREIGN KEY(REV) REFERENCES PUBLIC.AUDITEVENT(REVISIONNUMBER) NOCHECK;
...
ALTER TABLE PUBLIC.TERMRELATION ADD CONSTRAINT PUBLIC.FK4CEED9F847C496CB FOREIGN KEY(GRAPH_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_INVERSEREPRESENTATION_AUD ADD CONSTRAINT PUBLIC.FK5D248B8434869AAE FOREIGN KEY(REV) REFERENCES PUBLIC.AUDITEVENT(REVISIONNUMBER) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_DESCRIPTIONBASE ADD CONSTRAINT PUBLIC.FK731CC81FBBD2C869 FOREIGN KEY(DESCRIPTIVEDATASETS_ID) REFERENCES PUBLIC.DESCRIPTIVEDATASET(ID) NOCHECK;
...
ALTER TABLE PUBLIC.TERMCOLLECTION_CREDIT ADD CONSTRAINT PUBLIC.FK7604C566258E060 FOREIGN KEY(TERMCOLLECTION_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.MULTIACCESSKEY_TAXONSCOPE ADD CONSTRAINT PUBLIC.FKCC7A356DB64A7B29 FOREIGN KEY(MULTIACCESSKEY_ID) REFERENCES PUBLIC.DESCRIPTIVEDATASET(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_REPRESENTATION ADD CONSTRAINT PUBLIC.FKA003835BBBD2C869 FOREIGN KEY(DESCRIPTIVEDATASET_ID) REFERENCES PUBLIC.DESCRIPTIVEDATASET(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_REPRESENTATION ADD CONSTRAINT PUBLIC.FKA003835BB31C4747 FOREIGN KEY(REPRESENTATIONS_ID) REFERENCES PUBLIC.REPRESENTATION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.MULTIACCESSKEY_COVEREDTAXON ADD CONSTRAINT PUBLIC.FK34EB896DB4555A9A FOREIGN KEY(MULTIACCESSKEY_ID) REFERENCES PUBLIC.DESCRIPTIVEDATASET(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_AUD ADD CONSTRAINT PUBLIC.FK628F58E234869AAE FOREIGN KEY(REV) REFERENCES PUBLIC.AUDITEVENT(REVISIONNUMBER) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_DESCRIPTIONBASE ADD CONSTRAINT PUBLIC.FK731CC81F33B8A841 FOREIGN KEY(DESCRIPTIONS_ID) REFERENCES PUBLIC.DESCRIPTIONBASE(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_INVERSEREPRESENTATION ADD CONSTRAINT PUBLIC.FK98592F33473FB677 FOREIGN KEY(INVERSEREPRESENTATIONS_ID) REFERENCES PUBLIC.REPRESENTATION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_ANNOTATION ADD CONSTRAINT PUBLIC.FKCBBA8CBD1E403E0B FOREIGN KEY(ANNOTATIONS_ID) REFERENCES PUBLIC.ANNOTATION(ID) NOCHECK;
ALTER TABLE PUBLIC.TERMRELATION ADD CONSTRAINT PUBLIC.FK4CEED9F84FF2DB2C FOREIGN KEY(CREATEDBY_ID) REFERENCES PUBLIC.USERACCOUNT(ID) NOCHECK;
...
ALTER TABLE PUBLIC.TERMCOLLECTION_RIGHTSINFO ADD CONSTRAINT PUBLIC.FK8F1F9C44258E060 FOREIGN KEY(TERMCOLLECTION_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_INVERSEREPRESENTATION ADD CONSTRAINT PUBLIC.FK98592F33ECEEF4AF FOREIGN KEY(DEFINEDTERMBASE_ID) REFERENCES PUBLIC.DEFINEDTERMBASE(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_REPRESENTATION_AUD ADD CONSTRAINT PUBLIC.FK21B88BAC34869AAE FOREIGN KEY(REV) REFERENCES PUBLIC.AUDITEVENT(REVISIONNUMBER) NOCHECK;
...
ALTER TABLE PUBLIC.MULTIACCESSKEY_NAMEDAREA ADD CONSTRAINT PUBLIC.FK1F5A7489B4555A9A FOREIGN KEY(MULTIACCESSKEY_ID) REFERENCES PUBLIC.DESCRIPTIVEDATASET(ID) NOCHECK;
...
ALTER TABLE PUBLIC.TERMRELATION ADD CONSTRAINT PUBLIC.FK4CEED9F8E0AD2C59 FOREIGN KEY(PARENT_ID) REFERENCES PUBLIC.TERMRELATION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.TERMCOLLECTION ADD CONSTRAINT PUBLIC.FK4CF19F94B7892921 FOREIGN KEY(ROOT_ID) REFERENCES PUBLIC.TERMRELATION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET ADD CONSTRAINT PUBLIC.FK668D5B9123DB7F04 FOREIGN KEY(DESCRIPTIVESYSTEM_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.TERMCOLLECTION_ORIGINALSOURCEBASE ADD CONSTRAINT PUBLIC.FK8F2D512A258E060 FOREIGN KEY(TERMCOLLECTION_ID) REFERENCES PUBLIC.TERMCOLLECTION(ID) NOCHECK;
...
ALTER TABLE PUBLIC.TERMRELATION ADD CONSTRAINT PUBLIC.FK4CEED9F8BC5DA539 FOREIGN KEY(UPDATEDBY_ID) REFERENCES PUBLIC.USERACCOUNT(ID) NOCHECK;
...
ALTER TABLE PUBLIC.DESCRIPTIVEDATASET_DESCRIPTIONBASE_AUD ADD CONSTRAINT PUBLIC.FK8959CE7034869AAE FOREIGN KEY(REV) REFERENCES PUBLIC.AUDITEVENT(REVISIONNUMBER) NOCHECK;
