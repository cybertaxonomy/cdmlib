...
CREATE CACHED TABLE PUBLIC.WORKINGSET_CREDIT(
    WORKINGSET_ID INTEGER NOT NULL,
    CREDITS_ID INTEGER NOT NULL,
    SORTINDEX INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_CREDIT;
CREATE CACHED TABLE PUBLIC.WORKINGSET_CREDIT_AUD(
    REV INTEGER NOT NULL,
    WORKINGSET_ID INTEGER NOT NULL,
    CREDITS_ID INTEGER NOT NULL,
    SORTINDEX INTEGER NOT NULL,
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_CREDIT_AUD;
...
CREATE CACHED TABLE PUBLIC.WORKINGSET_EXTENSION(
    WORKINGSET_ID INTEGER NOT NULL,
    EXTENSIONS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_EXTENSION;
CREATE CACHED TABLE PUBLIC.MEDIA_WORKINGSET_AUD(
    REV INTEGER NOT NULL,
    WORKINGSET_ID INTEGER NOT NULL,
    EXTENSIONS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_EXTENSION_AUD;
CREATE CACHED TABLE PUBLIC.WORKINGSET_IDENTIFIER(
    WORKINGSET_ID INTEGER NOT NULL,
    IDENTIFIERS_ID INTEGER NOT NULL,
    SORTINDEX INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_IDENTIFIER;
CREATE CACHED TABLE PUBLIC.WORKINGSET_IDENTIFIER_AUD(
    REV INTEGER NOT NULL,
    WORKINGSET_ID INTEGER NOT NULL,
    IDENTIFIERS_ID INTEGER NOT NULL,
    SORTINDEX INTEGER NOT NULL,
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_IDENTIFIER_AUD;
...
CREATE CACHED TABLE PUBLIC.WORKINGSET_ORIGINALSOURCEBASE(
    WORKINGSET_ID INTEGER NOT NULL,
    SOURCES_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_ORIGINALSOURCEBASE;
CREATE CACHED TABLE PUBLIC.WORKINGSET_ORIGINALSOURCEBASE_AUD(
    REV INTEGER NOT NULL,
    WORKINGSET_ID INTEGER NOT NULL,
    SOURCES_ID INTEGER NOT NULL,
    REVTYPE TINYINT
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WORKINGSET_ORIGINALSOURCEBASE_AUD;
...
CREATE CACHED TABLE PUBLIC.WORKINGSET_RIGHTSINFO(
    WORKINGSET_ID INTEGER NOT NULL,
    RIGHTS_ID INTEGER NOT NULL
);
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.MEDIA_RIGHTSINFO;
CREATE CACHED TABLE PUBLIC.WORKINGSET_RIGHTSINFO_AUD(
    REV INTEGER NOT NULL,
    WORKINGSET_ID INTEGER NOT NULL,
    RIGHTS_ID INTEGER NOT NULL,
    REVTYPE TINYINT
