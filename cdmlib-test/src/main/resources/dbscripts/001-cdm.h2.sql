...
ALTER TABLE PUBLIC.TERMRELATION ADD CONSTRAINT PUBLIC.FK4CEED9F847C496CB FOREIGN KEY(TERMTREE_ID) REFERENCES PUBLIC.FEATURETREE(ID) NOCHECK;
...
ALTER TABLE PUBLIC.FEATURETREE ADD CONSTRAINT PUBLIC.FK4CF19F94B7892921 FOREIGN KEY(ROOT_ID) REFERENCES PUBLIC.TERMRELATION(ID) NOCHECK;
