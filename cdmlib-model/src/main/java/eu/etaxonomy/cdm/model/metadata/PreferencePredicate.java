...
//	//this should be replaced by a termSortOrderEnum  (instead of boolean), enum should contain label, abbrevLabel, idInVoc, symbol1, symbol2, ...
...
//    ShowSymbolForStatus(UUID.fromString("1ee6b945-0a81-4f05-b867-f9d105882249"), "Distribution Editor: Show Symbol for Status", "distribution.editor.status.showSymbol", Boolean.FALSE),
//    ShowIdInVocabulary(UUID.fromString("7b671bba-1b7f-4cb9-bbac-c914518a4bf8"), "Distribution Editor: Show ID in Vocabulary for Areas", "distribution.editor.areas.showIdInVoc",  Boolean.FALSE),
//    ShowSymbol1(UUID.fromString("aca6210e-75e8-4744-9000-c1e6740a5f66"), "Distribution Editor: Show Symbol1 for Areas", "distribution.editor.areas.showSymbol",  Boolean.FALSE),
//    ShowSymbol2(UUID.fromString("6043723f-3141-4350-b3b8-4b6fa02eb519"), "Distribution Editor: Show Symbol2 for Areas", "distribution.editor.areas.showSymbol2",  Boolean.FALSE),
//
...
//******************* TAXEDITOR **************************************/
    ...
    //editor
//    TaxonNodeOrder(UUID.fromString("ce06bd8e-4371-4ee5-8f57-cf23930cfd12"), "Taxon node order", "model.taxon.TNO", null),  //default alphabet + rank
//    NameDetailsView(UUID.fromString("3c4ec5f5-feb5-44a8-8533-c3c3484a6869"), "NameDetailsView", "model.editor.NDV", null),
//    IsRedList(UUID.fromString("aaf79c57-b2a9-48a6-b037-fc1b4a75a6e9"), "isRedList", "model.editor.RL", Boolean.FALSE),
