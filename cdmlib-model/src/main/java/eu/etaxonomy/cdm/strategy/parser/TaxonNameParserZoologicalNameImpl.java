 ...
 *
 */
public class TaxonNameParserZoologicalNameImpl implements ITaxonNameParser<ZoologicalName> {
	private static final Logger logger = Logger.getLogger(TaxonNameParserZoologicalNameImpl.class);
	
	// good intro: http://java.sun.com/docs/books/tutorial/essential/regex/index.html
	
	public static TaxonNameParserZoologicalNameImpl NewInstance(){
		return new TaxonNameParserZoologicalNameImpl();
	}
	 ...
	 */
	public ZoologicalName parseSimpleName(String simpleName, Rank rank){
		//TODO
	 ...
	 */
	public ZoologicalName parseSimpleName(String simpleName){
	 ...
	 */
	public ZoologicalName parseFullReference(String fullReferenceString, Rank rank) {
		if (fullReferenceString == null){
			return null;
		}else{
			ZoologicalName result = ZoologicalName.NewInstance(null);
	 ...
	 */
	public void parseFullReference(ZoologicalName nameToBeFilled, String fullReferenceString, Rank rank, boolean makeEmpty) {
		if (fullReferenceString == null){
			//return null;
			return;
		}
	 ...
	 */ 
	String parseNomStatus(String reference, ZoologicalName nameToBeFilled) {
		String statusString;
	...
	private void parseReference(ZoologicalName nameToBeFilled, String reference, boolean isInReference){
	 ...
	 */
	public ZoologicalName parseFullName(String fullNameString){
	 ...
	 */
	public ZoologicalName parseFullName(String fullNameString, Rank rank) {
	...
	public void parseFullName(ZoologicalName nameToBeFilled, String fullNameString, Rank rank, boolean makeEmpty) {
		//TODO prol. etc.
...
//		    }
	...
	private void makeEmpty(ZoologicalName nameToBeFilled){
	...
	private ZoologicalName parseHybrid(String fullName){
