...
public class CdDvdDefaultCacheStrategy <T extends CdDvd> extends NomRefDefaultCacheStrategyBase<T>  implements  INomenclaturalReferenceCacheStrategy<T> {
	...
	public static CdDvdDefaultCacheStrategy NewInstance(){
		return new CdDvdDefaultCacheStrategy<CdDvd>();
	}
