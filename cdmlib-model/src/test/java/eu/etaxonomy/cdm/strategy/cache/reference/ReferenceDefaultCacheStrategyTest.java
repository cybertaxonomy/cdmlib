...
/**
 * Copy of {@link ArticleDefaultCacheStrategyTest} to test the
 * {@link ReferenceDefaultCacheStrategy}.
 *
 * @author a.mueller
 * @since 25.05.2016
 */
public class ReferenceDefaultCacheStrategyTest {
    ...
    public void testArticleGetTitleCache() {
        ...
        Assert.assertEquals(
                "Team1 1975: My article. " + UTF8.EN_DASH + " " + ReferenceDefaultCacheStrategy.UNDEFINED_JOURNAL,
                article1.getTitleCache());
    }
    ...
    public void testSetInJournal() {
        ...
        Assert.assertEquals(
                "Team1: My article. " + UTF8.EN_DASH + " " + ReferenceDefaultCacheStrategy.UNDEFINED_JOURNAL,
                article1.getTitleCache());
    }
    ...
    public void testArticleGetTitleCacheWithPages() {
        ...
        Assert.assertEquals("Team1 1975: My article. " + UTF8.EN_DASH + " My journal 7: 12-22",
                article1.getTitleCache());

        article1.setSeriesPart("II");
        // TODO unclear if punctuation is correct
        Assert.assertEquals("Team1 1975: My article. " + UTF8.EN_DASH + " My journal, II, 7: 12-22",
                article1.getTitleCache());
    }
    ...
    public void testArticleGetAbbrevTitleCache() {
        ...
        Assert.assertEquals("T. 1975: M. Art. " + UTF8.EN_DASH + " M. Journ.",
                defaultStrategy.getFullAbbrevTitleString((Reference) article1));
        article1.setVolume("7");
        Assert.assertEquals("T. 1975: M. Art. " + UTF8.EN_DASH + " M. Journ. 7",
                defaultStrategy.getFullAbbrevTitleString((Reference) article1));
    }
    ...
    @Test
    public void testArticleGetTitleWithoutYearAndAuthor() throws NoSuchMethodException, SecurityException,
        ...
        article1.setDatePublished(VerbatimTimePeriod.NewVerbatimInstance(1975));
        Method method = ReferenceDefaultCacheStrategy.class.getDeclaredMethod("getTitleWithoutYearAndAuthor",
                Reference.class, boolean.class, boolean.class);
        method.setAccessible(true);
        Assert.assertEquals("My article. " + UTF8.EN_DASH + " My journal, ser. 2, 34",
                method.invoke(defaultStrategy, article1, false, false));
        Assert.assertEquals("My art. " + UTF8.EN_DASH + " My journ., ser. 2, 34",
                method.invoke(defaultStrategy, article1, true, false));
    ...
    public void testArticleOldExistingBugs() {
        ...
        Assert.assertEquals("Babc. & Stebbins 1943: " + UTF8.EN_DASH + " Univ. Calif. Publ. Bot. 18",
                defaultStrategy.getTitleCache((Reference) article1));
    }
    ...
    public void testBookGetTitleCache0() {
        ...
        book1.setTitleCache(null, false);
        // TODO this behaviour needs to be discussed. Maybe better the complete date
        // published string should be returned.
    ...
    public void testBookGetTitleCache1() {
        ...
        Assert.assertEquals("Unexpected abbrev title cache", "1955: Acta Inst. Bot. Acad. Sci. URSS Fasc. 11",
                book1.getTitleCache());
        book1.setSeriesPart("1");
        // TODO needs to be discussed
        Assert.assertEquals("Unexpected abbrev title cache", "1955: Acta Inst. Bot. Acad. Sci. URSS, ser. 1, Fasc. 11",
                book1.getTitleCache());
    }
    ...
    public void testPublisher() {
        ...
        // check if there is a double point at the end of the volume. Deduplicate if
        // present.
    ...
    public void testBookSectionGetTitleCache() {
        ...
        Assert.assertEquals("Unexpected title cache.",
                "Section Author 1975: My chapter. " + UTF8.EN_DASH + " In: Book Author, My book",
                bookSection1.getTitleCache());
        ...
        book1.setTitleCache(null, false);
        Assert.assertEquals("Unexpected title cache.",
                "Section Author 1976: My chapter. " + UTF8.EN_DASH + " In: Book Author, My book",
                bookSection1.getTitleCache());
        ...
        Assert.assertEquals("Unexpected title cache.",
                "Section Author 1976: My chapter. " + UTF8.EN_DASH + " In: Book Author, My book, ser. 2",
                bookSection1.getTitleCache());
        ...
        book1.setTitleCache(null, false);
        Assert.assertEquals("Unexpected title cache.",
                "Section Author 1976 " + UTF8.EN_DASH + " In: Book Author, My book, ser. 2",
                bookSection1.getTitleCache());
        bookSection1.setTitle(bookSetionTitle);
        ...
        bookSection1.setTitleCache(null, false);
        Assert.assertEquals("Unexpected title cache.",
                "Section Author 1976: My chapter, pp. 33-38. " + UTF8.EN_DASH + " In: Book Author, My book, ser. 2",
                bookSection1.getTitleCache());
        bookSection1.setPages("v");
        bookSection1.setTitleCache(null, false);
        Assert.assertEquals("Unexpected title cache.",
                "Section Author 1976: My chapter, p. v. " + UTF8.EN_DASH + " In: Book Author, My book, ser. 2",
                bookSection1.getTitleCache());
        ...
        bookSection1.setTitleCache(null, false);
        Assert.assertEquals("Unexpected title cache.",
                "Section Author 1976: My chapter. " + UTF8.EN_DASH + " In: - undefined book -",
                bookSection1.getTitleCache());
    }
    ...
    public void testBookSectionRealExample() {
        ...
        Assert.assertEquals("Chaudhary S. A. 2000: 73. Hedypnois - 87. Crepis, pp. 222-251. " + UTF8.EN_DASH
                + " In: Chaudhary S. A.(ed.), Flora of the Kingdom of Saudi Arabia 2(3). " + UTF8.EN_DASH
                + " Riyadh: National Herbarium", bookSection.getTitleCache());
    }
    ...
    public void testSectionInArticle() {
        ...
        Team articleTeam = Team.NewTitledInstance(
                "Kulikovskiy, M., Chudaev, D.A., Glushchenko, A., Kuznetsova, I. & Kociolek, J.P.", null);
        ...
        Team sectionTeam = Team.NewTitledInstance("Chudaev, D.A., Glushchenko, A., Kulikovskiy, M. & Kociolek, J.P.",
                null);
        ...
        Assert.assertEquals("Unexpected title cache.",
                "Chudaev, D.A., Glushchenko, A., Kulikovskiy, M. & Kociolek, J.P. 2020 " + UTF8.EN_DASH + " In: "
                        ...
                        + "New diatom species Navicula davidovichii from Vietnam (Southeast Asia). " + UTF8.EN_DASH
                        + " Phytotaxa 452(1)",
    ...
    public void testSectionInJournal() {
        ...
        journal.setTitle("Phytotaxa");
        Reference section = ReferenceFactory.newSection();
        Team sectionTeam = Team.NewTitledInstance(
                "Kulikovskiy, M., Chudaev, D.A., Glushchenko, A., Kuznetsova, I. & Kociolek, J.P.", null);
        section.setAuthorship(sectionTeam);
        ...
        Assert.assertEquals("Unexpected title cache.",
                "Kulikovskiy, M., Chudaev, D.A., Glushchenko, A., Kuznetsova, I. & Kociolek, J.P. 2020 " + UTF8.EN_DASH
                        + " In: " + "Phytotaxa 452(1)",
                section.getTitleCache());
    }
    ...
    public void testSectionInBookSection() {
        ...
        Assert.assertEquals(
                "Unexpected title cache.", "Section author 1752 " + UTF8.EN_DASH
                        + " In: Chapter author, Trees, pp. 83-91. " + UTF8.EN_DASH + " In: Linne, Species Plantarum 3",
                section.getTitleCache());
    }
    ...
    public void testGenericGetTitleCache2() {
        ...
        Assert.assertEquals("Unexpected title cache.",
                "Part Title. " + UTF8.EN_DASH + " In: Authorteam, My book title. " + UTF8.EN_DASH + " Berlin: Springer",
                generic1.getTitleCache());
    }
    ...
    public void testGenericGetAbbrevTitleCache() {
        ...
        Assert.assertEquals("Unexpected abbrev title cache.",
                "1987: Pt. Tit. " + UTF8.EN_DASH + " In: AT., My bk. tit.",
                defaultStrategy.getFullAbbrevTitleString((Reference) generic1));

        // protected
        generic1.setAbbrevTitleCache("My prot. abb. tit. in a bk.", true);
        Assert.assertEquals("Unexpected abbrev title cache.", "My prot. abb. tit. in a bk.",
                defaultStrategy.getFullAbbrevTitleString((Reference) generic1));
    }
    ...
    public void testGenericNomenclaturalTitle() {
        ...
        generic1.setTitleCache(null, false); // reset cache in case aspectJ is not enabled
        generic1.setAbbrevTitleCache(null, false); // reset cache in case aspectJ is not enabled
        Assert.assertEquals("Unexpected abbrev title cache.", "in AT., My bk. tit. 1987",
                generic1.getAbbrevTitleCache());
        Assert.assertEquals("Title cache must still be the same",
                "1987: Part Title. " + UTF8.EN_DASH + " In: Authorteam, My book title", generic1.getTitleCache());
    ...
    public void testGenericGetTitleCacheWithoutInRef() {
        ...
        generic1.setTitleCache(null, false); // reset cache in case aspectJ is not enabled
        Assert.assertEquals("Unexpected title cache.",
                "Authorteam: My generic title. " + UTF8.EN_DASH + " Berlin: Springer", generic1.getTitleCache());
    }
    ...
    public void testGenericMissingVolume() {
        ...
        // Assert.assertEquals("in InRefAuthor, My InRef 7: 55. 1883"+SEP+"1884",
        // generic1.getNomenclaturalCitation(detail1));
        // Assert.assertEquals("Authorteam - My generic in InRefAuthor, My InRef 7.
        // 1883-1884", generic1.getTitleCache());
        // Assert.assertEquals("AT. - My generic in InRefAuthor, My InRef 7. 1883-1884",
        // generic1.getAbbrevTitleCache());
        ...
        Assert.assertEquals(
                "Authorteam 1883" + SEP + "1884: My generic. " + UTF8.EN_DASH + " In: InRefAuthor, My InRef 9",
                generic1.getTitleCache());
        Assert.assertEquals("AT. in InRefAuthor, My InRef 9. 1883" + UTF8.EN_DASH + "1884",
                generic1.getAbbrevTitleCache());
    }
    ...
    public void testWebPageGetTitleCache() {
        ...
        Assert.assertEquals("Unexpected title cache.", "http://flora.huji.ac.il", webPage1.getTitleCache());
        ...
        Assert.assertEquals("Unexpected title cache.", "Authorteam, D.: Flora of Israel Online " + UTF8.EN_DASH
                + " http://flora.huji.ac.il [accessed 2001-01-05]", webPage1.getTitleCache());
    }

    // @Test
    // //WebPages should usually not be used as nomencl.reference, therefore this is
    // less important
    // public void testWebPageGetAbbrevTitleCache(){
    // webPage1.setTitle("auct.");
    // Assert.assertEquals("Unexpected title cache.", "auct.",
