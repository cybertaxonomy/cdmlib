...
// ***************************** Book Section ************************/
	...
	public void testBookSectionSetInBook() {
		...
		bookSection1.setInBook(null);
		Assert.assertEquals("Unexpected title cache.",
				"Section Author 1975: My chapter. " + UTF8.EN_DASH + " In: - undefined book -",
				bookSection1.getTitleCache());
	}
	...
	public void testBookSectionRealExample() {
		...
		Assert.assertEquals(
				"Chaudhary S. A. 2000: 73. Hedypnois - 87. Crepis, pp. 222-251. " + UTF8.EN_DASH
						+ " In: Chaudhary S. A.(ed.), Flora of the Kingdom of Saudi Arabia 2(3)",
				bookSection.getTitleCache());
	}
...
// *************************** GENERIC *****************************************/
	...
	public void testGenericGetTitleCache2() {
		...
		Assert.assertEquals("Unexpected title cache.", "Part Title. " + UTF8.EN_DASH + " In: Authorteam, My book title",
