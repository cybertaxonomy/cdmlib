...
public abstract class SpecimenOrObservationBaseDTO<T extends SpecimenOrObservationBase<?>>
    ...
    private Set<DerivedUnitDTO> derivatives = new TreeSet<>(DerivedUnitDtoComparator.INSTANCE());
    ...
    public void setRecordBase(EntityReference specimenOrObservationType) {
