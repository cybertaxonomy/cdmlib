 ...
 * @version 1.0
 */
public abstract class SapindaceaeImportBase  extends CdmImportBase<SapindaceaeImportConfigurator, SapindaceaeImportState> {
	private static final Logger logger = Logger.getLogger(SapindaceaeImportBase.class);

	
	protected abstract boolean doInvoke(SapindaceaeImportState state);
...
//	}
	...
	protected Element getBodyElement(SapindaceaeImportConfigurator config){
