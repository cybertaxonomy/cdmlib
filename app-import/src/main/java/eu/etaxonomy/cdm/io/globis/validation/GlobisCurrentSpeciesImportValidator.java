 ...
 * @version 1.0
 */
public class GlobisCurrentSpeciesImportValidator implements IOValidator<GlobisImportState>{
	private static final Logger logger = Logger.getLogger(GlobisCurrentSpeciesImportValidator.class);
