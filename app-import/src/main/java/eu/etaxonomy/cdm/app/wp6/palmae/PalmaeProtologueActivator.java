...
public class PalmaeProtologueActivator extends AbstractImageImporter {
	...
	private static final File sourceFile = new File("src/main/resources/images/Protologue_links_for_CDM.xls");
	private static final ICdmDataSource cdmDestination = CdmDestinations.cdm_test_niels1();
