 ...
 * @version 1.0
 */
public class LIASUpdateActivator {
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(LIASUpdateActivator.class);

	//database validation status (create, update, validate ...)
	static DbSchemaValidation hbm2dll = DbSchemaValidation.UPDATE;
	static final String sddSource = SDDSources.LIAS_local();
	static final ICdmDataSource cdmDestination = CdmDestinations.localH2();

	//	static final ICdmDataSource cdmDestination = CdmDestinations.cdm_portal_test_localhost();

	static final String sourceSecId = "LIAS_pub_ed_999999";
