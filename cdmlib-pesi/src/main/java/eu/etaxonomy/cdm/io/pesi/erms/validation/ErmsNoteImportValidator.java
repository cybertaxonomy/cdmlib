 ...
 * @version 1.0
 */
public class ErmsNoteImportValidator implements IOValidator<ErmsImportState>{
	private static final Logger logger = Logger.getLogger(ErmsNoteImportValidator.class);
