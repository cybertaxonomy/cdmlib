...
/**
 * This class is meant for generic cdmlib-remote testing. It may be adapted as required,
...
//		deleteHighLevelNode(appCtr);   //->problem with Duplicate Key in Classification_TaxonNode 		
	...
	private void testDistributionTree(CdmApplicationController appCtr) {
		...
		DistributionTree tree = ctl.doGetOrderedDistributionsB(descriptionUuidList, levels, request, response);
		tree.toString();
	}
