...
public class PubTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		ICdmApplicationDefaultConfiguration app = CdmIoApplicationController.NewInstance(resource, dataSource, DbSchemaValidation.VALIDATE, false, progressMonitor);
		//ICdmApplicationDefaultConfiguration app = CdmApplicationController.NewInstance(resource, dataSource, DbSchemaValidation.VALIDATE, false, progressMonitor);
