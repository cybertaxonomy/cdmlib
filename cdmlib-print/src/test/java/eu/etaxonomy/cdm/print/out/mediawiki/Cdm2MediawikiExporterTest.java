...
public class Cdm2MediawikiExporterTest {
	...
	public void testExport() throws MalformedURLException {
		// do complete export
		exporter.export(webServiceUrl, taxonName, classificationName, wikiUrl, loginName,
				password, wikiPrefix, false, false, true);
	...
	public void testExportFromXmlFile() throws MalformedURLException {
		...
		exporter.exportFromXmlFile(cdmExported, webServiceUrl, taxonName, null,
				wikiUrl, loginName, password, wikiPrefix, true, false, false);
	}
