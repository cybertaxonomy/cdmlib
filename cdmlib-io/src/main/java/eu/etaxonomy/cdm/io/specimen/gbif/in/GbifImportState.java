 ...
 * @since 15.07.2016
 */
public class GbifImportState
        extends SpecimenImportStateBase<GbifImportConfigurator<GbifImportState, InputStream>, GbifImportState> {
...
//    }
    ...
    @Override
    public void setIndividualsAssociationDescriptionPerTaxon(TaxonDescription descriptionGroup) {
