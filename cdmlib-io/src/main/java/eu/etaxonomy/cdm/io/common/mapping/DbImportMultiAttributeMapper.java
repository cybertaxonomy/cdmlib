 ...
 * @version 1.0
 */
public abstract class DbImportMultiAttributeMapper<CDMBASE extends CdmBase, STATE extends DbImportStateBase<?,?>> extends MultipleAttributeMapperBase<CdmSingleAttributeMapperBase> implements IDbImportMapper<STATE, CDMBASE>{
	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(DbImportMultiAttributeMapper.class);
