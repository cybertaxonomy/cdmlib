...
public final class SDDTransformer {
	...
	public static TypeDesignationStatus typeStatusId2TypeStatus (int typeStatusId)  throws UnknownCdmTypeException{
		switch (typeStatusId){
			// The class representing status (categories) of SpecimenTypeDesignation specimen type designations
		 	// for a TaxonNameBase taxon name or a set of them.
