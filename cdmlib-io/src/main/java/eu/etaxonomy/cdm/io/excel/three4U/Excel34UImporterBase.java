 ...
 * @version 1.0
 */
public abstract class Excel34UImporterBase extends ExcelTaxonOrSpecimenImportBase<Excel34UImportState, Excel34URow> {
	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(Excel34UImporterBase.class);
