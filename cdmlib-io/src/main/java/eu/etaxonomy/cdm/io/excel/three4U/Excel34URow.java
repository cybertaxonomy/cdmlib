 ...
 * @version 1.0
 */
public class Excel34URow extends ExcelRowBase {
	...
	public Excel34URow(String name, int parentId) {
		this(name, parentId, null);
	}
	
	public Excel34URow(String scientificName, int parentId, String reference) {
...
// **************************** GETTER / SETTER *********************************/	
	...
	/**
	 * 
	 * @param synonym the synonym name to set
	 */
