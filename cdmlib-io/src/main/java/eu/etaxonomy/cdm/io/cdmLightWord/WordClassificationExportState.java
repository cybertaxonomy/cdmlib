 ...
 * @date 29.06.2022
 */
public class WordClassificationExportState
        extends TaxonTreeExportStateBase<WordClassificationExportConfigurator, WordClassificationExportState>{
    ...
    protected WordClassificationExportState(WordClassificationExportConfigurator config) {
        super(config);
    ...
    protected WordClassificationExportResultProcessor getProcessor() {
        return processor;
    }
