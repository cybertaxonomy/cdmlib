...
public class FaunaEuropaeaDistributionImport  extends FaunaEuropaeaImportBase {
	...
	public FaunaEuropaeaDistributionImport(){
		super();
	}
	...
	protected boolean doCheck(IImportConfigurator config){
		boolean result = true;
		FaunaEuropaeaImportConfigurator bmiConfig = (FaunaEuropaeaImportConfigurator)config;
...
//******************************** CHECK *************************************************
	...
	private static boolean checkTaxonIsAccepted(FaunaEuropaeaImportConfigurator bmiConfig){
		try {
			boolean result = true;
            ...
            while (rs.next()){
                ...
                try {
                    //status
                     ...
                     if (emStatusId != null){
                                 status = FaunaEuropaeaTransformer.occStatus2PresenceAbsence(emStatusId);
                     }
