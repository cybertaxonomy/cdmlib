 ...
 */
@Component
public class BciServiceWrapper_Old extends ServiceWrapperBase<Collection> implements IBciServiceWrapper{
	private static final Logger logger = Logger.getLogger(BciServiceWrapper_Old.class);
